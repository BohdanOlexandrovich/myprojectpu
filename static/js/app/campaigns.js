...
function processCampaignsLimit(campaignTable, campaigns) {
    $.each(campaigns, function(i, campaign) {
                    ...
                    deletecampaign = "<button class='btn btn-danger' onclick='deleteCampaign(" + i + ")' data-toggle='tooltip' data-placement='left' title='Delete Campaign'>\
                    ...
                    campaignTable.row.add([
                        ...
                        "<div class='pull-right'><a class='btn btn-primary' href='" + campaignsahref + campaign.id + "' data-toggle='tooltip' data-placement='left' title='View Results'>\
